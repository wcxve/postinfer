...
html_theme_options = {
    'github_url': 'https://github.com/wcxve/postinfer',
    'show_nav_level': 2,
    'footer_start': ['copyright'],
}
html_title = 'postinfer'
html_static_path = ['_static']
html_css_files = ['custom.css']
# html_logo = '_static/logo.png'
# html_favicon = '_static/favicon.svg'
html_baseurl = 'https://postinfer.readthedocs.io/en/latest/'
